...
//
//        // When
//        final GetEdges<EntitySeed> op = new GetEdges<>(Collections.singletonList(seed1));
//
//        // Then
...
//        final GetEdges<EntitySeed> op = new GetEdges<>(Arrays.asList(seed1, seed2));
//
//        // When
...
//    @Override
//    public void builderShouldCreatePopulatedOperation() {
//        final GetEdges<EntitySeed> getRelatedEdges = new GetEdges.Builder<GetEdges<EntitySeed>, EntitySeed>()
